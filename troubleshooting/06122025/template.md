...
Here's a shell script template for automating the recovery process:
...
WHERE database='$DATABASE' AND table='$TABLE' AND reason=''")
...
WHERE database='$DATABASE' AND table='$TABLE' AND is_readonly=1")
